<!-- 10/24/24
 ...
 <head>
     ...
     <!-- Good resource for icons: fontawesome.com
      ...
      <!-- 'defer' attribute ensures that these scripts are loaded in order -->
      <script scr="https://unpkg.com/just-validate@latest/dist/just-validate.production.min.js" defer></script>   <!-- for client-side validation -->
      <script scr="/js/validation.js" defer></script>   <!-- for custom JavaScript -->
 </head>
 <body>
      ...
      <div class="login">
         <div class="login__container">  <!-- only holds the login box -->
             <div class="login__content">
                 ...
                 <form action="process-login.php" method="post" id="signup" novalidate>  <!-- 'form' is a container for different kinds of input elements -->
